                ...
                try
                {
                    switch (alg1)
                    {
                        ...
                        case "Пузырьковая сортировка":
                            ...
                            break;
                        case "Сортировка по ведру":
                            sa.BucketSort(array1);
                            break;
                        case "гребенчатая сортировка":
                            sa.CombSort(array1);
                            break;
                        case "Цикл сортировки":
                            sa.CycleSort(array1);
                            break;
                        case "Сортирвока гномов":
                            sa.GnomeSort(array1);
                            break;
                        case "Сортировка кучи":
                            sa.HeapSort(array1);
                            break;
                        ...
                        case "Сортировка слиянием":
                            ...
                            break;
                        case "Четно-нечетная сортировка":
                        ...
                        case "Быстрая сортировка с пузырьковой сортировкой":
                            ...
                            break;
                        case "Выбор Сортировка":
                            sa.SelectionSort(array1);
                            break;
                        case "Сортировка оболочки":
                            sa.ShellSort(array1);
                            break;
                        case "Сортировка голубиных отверстий":
